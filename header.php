...
<div id="page" class="site">
	...
	<header id="main-header" class="fixed top-6 left-0 right-0 z-50 px-4 flex justify-center transition-all duration-300">
		<div class="w-full max-w-6xl bg-white shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-full px-6 py-3 grid grid-cols-3 items-center border border-gray-100">
			...
			<nav class="hidden md:flex items-center justify-self-center gap-2">
			...
			<div class="flex items-center gap-4 justify-self-end text-gray-400">
				<!-- Instagram -->
