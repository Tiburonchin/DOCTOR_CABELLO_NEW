...
<div id="page" class="site">
	...
	<header id="main-header" class="fixed top-6 left-0 right-0 z-50 px-4 flex justify-center transition-all duration-300">
		...
		<!-- Mobile Menu Overlay -->
		<div id="mobile-menu" class="fixed inset-0 bg-[#0f172a] z-[60] flex flex-col translate-x-full transition-transform duration-500 lg:hidden">
			
			<!-- Mobile Menu Header -->
			<div class="flex justify-between items-center px-8 py-8 border-b border-gray-800/50">
			...
			<nav class="flex-1 flex flex-col px-8 mt-4">
				<a href="#inicio" class="mobile-nav-link py-6 text-3xl font-display font-bold text-white border-b border-gray-800/50 hover:text-primary transition-colors">
					Inicio
				</a>
				<a href="#tratamientos" class="mobile-nav-link py-6 text-3xl font-display font-bold text-white border-b border-gray-800/50 hover:text-primary transition-colors">
					Tratamientos
				</a>
				<a href="#nosotros" class="mobile-nav-link py-6 text-3xl font-display font-bold text-white border-b border-gray-800/50 hover:text-primary transition-colors">
					Nosotros
				</a>
				<a href="#contacto" class="mobile-nav-link py-6 text-3xl font-display font-bold text-white border-b border-gray-800/50 hover:text-primary transition-colors">
					Contacto
				</a>
			</nav>
			...
			<div class="px-8 py-12 mt-auto flex justify-between items-end">
				...
				<!-- Grupo de Redes Sociales (Estilo Switcher) -->
