...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700;800&family=Newsreader:ital,opsz,wght@0,6..72,300..400;1,6..72,300..400&family=Outfit:wght@400;700&display=swap" rel="stylesheet">
...
<div id="page" class="site min-h-screen">
		...
		<div class="w-full max-w-[1360px] bg-white shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-full px-8 py-4 flex justify-between items-center border border-gray-100">
			...
			<div class="flex items-center gap-4">
				<nav class="hidden lg:flex items-center gap-1">
					<a href="#hero-section" data-target="hero-section" class="nav-link active">
						Bienvenido
					</a>
					<a href="#portfolio" data-target="portfolio" class="nav-link">
						Resultados
					</a>
					<a href="#procedimientos-section" data-target="procedimientos-section" class="nav-link">
						Transplante Capilar
					</a>
					<a href="#analisis-paciente" data-target="analisis-paciente" class="nav-link">
						Tu Proceso
					</a>
					<a href="#conocenos" data-target="conocenos" class="nav-link">
						Conócenos
					</a>
					<a href="#contacto" data-target="contacto" class="nav-link ml-4 bg-primary-600 text-white px-6 py-2.5 rounded-full font-bold text-sm transition-all duration-300 hover:bg-primary-700 hover:shadow-lg hover:-translate-y-0.5 active:scale-95">
						Contáctanos
					</a>
				</nav>
	...
	<div id="mobile-menu" class="fixed inset-0 bg-gray-900 z-[100] flex flex-col translate-x-full transition-transform duration-500 lg:hidden">
		...
		<nav class="flex-1 flex flex-col px-8 mt-4">
			<a href="#hero-section" class="mobile-nav-link py-6 text-3xl font-display font-bold text-white border-b border-white/5 hover:text-primary-600 transition-colors">
				Bienvenido
			</a>
			<a href="#portfolio" class="mobile-nav-link py-6 text-3xl font-display font-bold text-white border-b border-white/5 hover:text-primary-600 transition-colors">
				Resultados
			</a>
			<a href="#procedimientos-section" class="mobile-nav-link py-6 text-3xl font-display font-bold text-white border-b border-white/5 hover:text-primary-600 transition-colors">
				Transplante Capilar
			</a>
			<a href="#analisis-paciente" class="mobile-nav-link py-6 text-3xl font-display font-bold text-white border-b border-white/5 hover:text-primary-600 transition-colors">
				Tu Proceso
			</a>
			<a href="#conocenos" class="mobile-nav-link py-6 text-3xl font-display font-bold text-white border-b border-white/5 hover:text-primary-600 transition-colors">
				Conócenos
			</a>
			<a href="#contacto" data-target="contacto" class="mobile-nav-link py-6 text-3xl font-display font-bold text-primary-500 border-b border-white/5 hover:text-white transition-colors">
				Contáctanos
			</a>
		</nav>

		<!-- Mobile Menu Footer -->
		<div class="px-8 py-12 mt-auto flex justify-end items-end">
