    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        ...
        <div class="lg:col-span-4 lg:sticky lg:top-32 anim-video-player flex justify-center">
            <div id="main-player-container" class="relative w-full max-w-[380px] aspect-[9/16] bg-white/10 backdrop-blur-2xl rounded-[2.5rem] p-2 shadow-[0_20px_50px_rgba(var(--color-primary-600),0.15)] border border-white/20 group">
                <!-- Pantalla del video -->
                <div id="main-video-wrapper" class="relative w-full h-full rounded-[2rem] overflow-hidden bg-gray-900/40 shadow-inner">
                    <!-- Video Principal -->
                    <video id="main-video-player" 
                           class="w-full h-full object-cover transition-transform duration-1000" 
                           poster="https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=720&h=1280&fit=crop"
                           preload="none"
                           playsinline>
                        <source id="main-video-source" src="<?php echo get_template_directory_uri(); ?>/assets/video/Hero_section_new2.mp4" type="video/mp4">
                    ...
                    <!-- Botón Play Central -->
                    <div id="play-button-overlay" class="absolute inset-0 flex items-center justify-center cursor-pointer hover:bg-black/10 transition-colors duration-300">
                        <div class="w-20 h-20 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center border border-white/30 transform transition-all duration-300 hover:scale-110 shadow-2xl">
                    ...
                    <div class="absolute bottom-6 left-6 right-6 flex flex-col gap-3 pointer-events-none">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="bg-black/50 backdrop-blur text-white text-xs px-2 py-1 rounded-full flex items-center gap-1">
                                <i data-lucide="clock" class="w-3 h-3"></i> HD
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="lg:col-span-8 flex flex-col gap-10 lg:pt-4">
            ...
            <div class="anim-playlist">
                ...
                <div class="flex overflow-x-auto lg:grid lg:grid-cols-3 gap-4 pb-4 no-scrollbar -mx-4 px-4 lg:mx-0 lg:px-0">
                         <!-- Item 1: Transplante Capilar FUE -->
                    <div class="playlist-item active relative flex-shrink-0 w-40 sm:w-48 lg:w-full aspect-[9/16] rounded-2xl overflow-hidden cursor-pointer group" 
                         onclick="changeVideo(this, 'Transplante Capilar Técnica FUE', 'Capilar', 'Nuestra técnica FUE permite una recuperación rápida y resultados 100% naturales, sin cicatrices lineales. Observa la precisión en la implantación folicular.', 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=720&h=1280&fit=crop', '<?php echo get_template_directory_uri(); ?>/assets/video/Hero_section_new2.mp4')">
                        ...
                        <div class="absolute bottom-0 left-0 p-4 z-10 w-full">
                            <h5 class="text-white font-semibold text-sm leading-tight line-clamp-2">Transplante Capilar FUE</h5>
                        </div>
                    </div>

                    <!-- Item 2: Diseño de Línea Frontal -->
                    <div class="playlist-item relative flex-shrink-0 w-40 sm:w-48 lg:w-full aspect-[9/16] rounded-2xl overflow-hidden cursor-pointer group" 
                         onclick="changeVideo(this, 'Diseño Personalizado de Línea Frontal', 'Capilar', 'El éxito de un transplante reside en el diseño. Creamos líneas frontales acordes a la fisionomía de cada paciente para un resultado imperceptible.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?q=80&w=720&h=1280&fit=crop', '<?php echo get_template_directory_uri(); ?>/assets/video/Hero_section_new2.mp4')">
                        ...
                        <div class="absolute bottom-0 left-0 p-4 z-10 w-full">
                            <h5 class="text-white font-semibold text-sm leading-tight line-clamp-2">Diseño de Línea Frontal</h5>
                        </div>
                    </div>

                    <!-- Item 3: Post-Operatorio y Resultados -->
                    <div class="playlist-item relative flex-shrink-0 w-40 sm:w-48 lg:w-full aspect-[9/16] rounded-2xl overflow-hidden cursor-pointer group" 
                         onclick="changeVideo(this, 'Evolución y Resultados Reales', 'Capilar', 'Acompañamos al paciente en todo el proceso. Mira la evolución desde el día 1 hasta los resultados finales a los 12 meses.', 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=720&h=1280&fit=crop', '<?php echo get_template_directory_uri(); ?>/assets/video/Hero_section_new2.mp4')">
                        <div class="absolute inset-0 border-[3px] border-transparent z-20 rounded-2xl pointer-events-none active-border transition-colors"></div>
                        ...
                        <div class="absolute bottom-0 left-0 p-4 z-10 w-full">
                            <h5 class="text-white font-semibold text-sm leading-tight line-clamp-2">Resultados 12 Meses</h5>
                        </div>
                    </div>

                     <!-- Item 4: Tratamiento PRP Complementario -->
                     <div class="playlist-item relative flex-shrink-0 w-40 sm:w-48 lg:w-full aspect-[9/16] rounded-2xl overflow-hidden cursor-pointer group" 
                          onclick="changeVideo(this, 'Tratamiento Capilar PRP', 'Capilar', 'El Plasma Rico en Plaquetas es el complemento ideal para potenciar el crecimiento y fortalecer el cabello trasplantado.', 'https://images.unsplash.com/photo-1527799820374-dcf8d9d4a388?q=80&w=720&h=1280&fit=crop', '<?php echo get_template_directory_uri(); ?>/assets/video/Hero_section_new2.mp4')">
                        <div class="absolute inset-0 border-[3px] border-transparent z-20 rounded-2xl pointer-events-none active-border transition-colors"></div>
                    ...
                    </div> <!-- Cierra flex overflow-x-auto -->
                </div> <!-- Cierra anim-playlist -->
